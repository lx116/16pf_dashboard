...
export default function CategorizationChart({respondent_id}) {
    ...
    useEffect(() => {
        const fetchPersonalityFactors = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/api/categorization/${respondent_id}/`);
        ...
        datasets: [
            {
                ...
                backgroundColor: 'rgba(40, 180, 120, 0.6)',
                borderColor: 'rgba(40, 180, 120, 1)',
                borderWidth: 1,
            },
        ],
    };
            ...
            <Bar
                ...
                options={{
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Categorizacion por Respondente',
                        },
                    },
                    scales: {
                        x: {
